...
local function get_tracks_to_show(settings)
    ...
    for i = 1, reaper.CountTracks(0) do
        ...
        if is_match("organ", name, idx)
          or is_match("synth", name, idx)
          or is_match("keys", name, idx)
          or is_match("piano", name, idx)then 
            if not (ischild and settings.matchonlytop) then
